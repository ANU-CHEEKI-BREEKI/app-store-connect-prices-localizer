/// <summary>
/// Manages the named profiles in ~/.config/ios-iap/profiles.json.
/// Runs entirely offline: no config is loaded and no App Store Connect key is read.
/// </summary>
public class Command_Config : CommandBase
{
    ...
    public override void PrintHelp()
    {
        ...
        CommandLinesUtils.PrintDescription("This command does not talk to App Store Connect.");
        ...
        CommandLinesUtils.PrintDescription("list -p                          # runs for island-raid", 4);
        CommandLinesUtils.PrintDescription("list -p --profile titan-souls    # one-off, current profile stays", 4);
    }
}
