public class CommandsCollection : List<CommandBase>
{
    public bool TryPrintHelp(string[] args)
    {
        ...
        Console.WriteLine();
        Console.WriteLine("------------------------------------------------------------------------------------------------");
        Console.WriteLine("this is a tool for managing App Store Connect In-App Purchases");
        ...
        CommandLinesUtils.PrintOption(
            "--app-id <app-id>",
            "Explicitly specify your app Identifier."
        );
        CommandLinesUtils.PrintOption(
            "--private-key <path>",
            "Explicitly specify the path to your Private key file."
        );
